...
`ci-run.yml` builds the current commit on the `ubicloud-standard-30` runner, packages the `zeroclaw` binary into a tarball, generates a SHA-256 file, and uploads both as an Actions artifact.
